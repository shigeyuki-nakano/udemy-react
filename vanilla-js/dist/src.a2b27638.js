...
require("./styles.css");
var incompleteListsEl = document.getElementById("incomplete-list");
var completeListsEl = document.getElementById("complete-list");
function createInCompleteListEl(text) {
  var todoItemEl = document.createElement("p");
  todoItemEl.classList.add("todo-item");
  todoItemEl.innerText = text;
  var completeButtonEl = document.createElement("button");
  ...
  var listRowEl = document.createElement("div");
  ...
  completeButtonEl.addEventListener("click", function () {
    listEl.remove();
    var completeListEl = createCompleteListEl(text);
...
function createCompleteListEl(text) {
  ...
  returnButtonEl.addEventListener("click", function () {
    listEl.remove();
    var inCompleteListEl = createInCompleteListEl(text);
    incompleteListsEl.appendChild(inCompleteListEl);
  });
  return listEl;
}
(function main() {
  var textEl = document.getElementById("add-text");
  ...
  buttonEl.addEventListener("click", function () {
    ...
    console.log("add");
    textEl.value = "";
    var listEl = createInCompleteListEl(text);
